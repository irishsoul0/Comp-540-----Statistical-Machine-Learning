...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
    ...
    self.params['theta2'] = weight_scale*np.random.randn(num_filters*(H/2)*(W/2), hidden_dim)
  ...
  def loss(self, X, y=None):
    ...
    dout1, grads['theta3'], grads['theta3_0'] = affine_backward(dloss, cache3)
    dout2, grads['theta2'], grads['theta2_0'] = affine_relu_backward(dout1, cache2)
    dout3, grads['theta1'], grads['theta1_0'] = conv_relu_pool_backward(dout2, cache1)
